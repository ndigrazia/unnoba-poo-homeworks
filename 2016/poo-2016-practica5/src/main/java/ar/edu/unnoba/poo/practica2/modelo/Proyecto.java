...
@NamedQuery(name="Proyecto.findHorasMenorA", query="SELECT p FROM Proyecto p where p.horasCoordinacion < :hora")
})
public class Proyecto extends GenericoEntity {
  ...
  public String toString() {
	  return "Nro: " + nro  + ", Descripción: " + descripcion;
  }
